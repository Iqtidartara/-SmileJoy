...
const About = () => {
  return (
    <section className="w-full ">
      <main className="max-w-[90rem] mx-auto md:py-[146px] py-12 md:px-[4rem] px-4 flex flex-col md:flex-row sm:flex-col md:gap-[100px] gap-12">
        <div><Image
            src="/about.png"
            alt="tara"
            width={600}
            height={600}
            className="md:w-full md:h-[519px] object-cover"
          />
        </div>
        <div className="md:w-1/2 w-full">
          <p className="text-[#FF6947] text-[1.25rem] font-[400] leading-normal">
          ...
          <Button
            className="borderbutton2 bg-[#FF7352] md:px-12 md:py-8 py-7 font-[500] text-[0.93519rem] leading-[150%] rounded-[10px] md:mt-[3.94rem] mt-8 w-full md:w-auto"
          >
